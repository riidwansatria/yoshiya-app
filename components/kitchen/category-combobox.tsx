...
export function CategoryCombobox({
    ...
    return (
        <div ref={rootRef}>
            ...
            >
                <ComboboxInput
                    placeholder={t('categoryCombobox.searchPlaceholder')}
                    showClear={!!value}
                    onKeyDown={handleKeyDown}
                />
                <CategoryComboboxContent container={portalContainer}>
                    <ComboboxEmpty>{t('categoryCombobox.empty')}</ComboboxEmpty>
                    <ComboboxList>
                        {(option) => (
                    ...
                    {inputValue.trim() && !exactMatch ? (
                        <div className="sticky bottom-0 bg-popover border-t p-1">
                            ...
                            >
                                ...
                                {t('categoryCombobox.createNamed', {
